...
import com.example.busschedule.model.BusScheduleViewModel
import com.example.busschedule.model.BusScheduleViewModelFactory
...
class StopScheduleFragment: Fragment() {
    ...
    private val viewModel: BusScheduleViewModel by activityViewModels {
        BusScheduleViewModelFactory(
            (activity?.application as BusScheduleApplication).repository
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycle.coroutineScope.launch {
            viewModel.filteredSchedule(stopName).collect {
